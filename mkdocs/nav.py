...
class SiteNavigation(object):
    def __init__(self, config):
        ...
        self.page_extension = config['page_extension']
...
class Page(object):
    def __init__(self, title, path, url_context, config):
        ...
        self._title = title
        self.abs_url = utils.get_url_path(path, config['use_directory_urls'], config['page_extension'])
        self.active = False
        ...
        self.output_path = utils.get_html_path(path, config['page_extension'])
